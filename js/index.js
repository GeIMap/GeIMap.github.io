...
var typearray = [
	...
	[LayerMap["Layer_JG_MD"], JS_JG_MD, "TX", 'JG_MD'],
	[LayerMap["Layer_JG_LY"], JS_JG_LY, "TX", 'JG_LY'],
	[LayerMap["Layer_MJK_MD"], JS_MJK_MD, "KW", 'MJK_MD'],
	[LayerMap["Layer_MJK_LY"], JS_MJK_LY, "KW", 'MJK_LY'],
	[LayerMap["Layer_S_LY"], JS_S_LY, "SC", 'S_LY'],
	[LayerMap["Layer_NQ_LY"], JS_NQ_LY, "LJ", 'NQ_LY'],
	[LayerMap["Layer_YSSP_MD"], JS_YSSP_MD, "TX", 'YSSP_MD'],
	[LayerMap["Layer_YSSP_LY"], JS_YSSP_LY, "TX", 'YSSP_LY'],
...
map.on('popupopen', function (e) {
	...
	if (timeValue) {
		...
		timer = setInterval(() => {
			...
			$(".myPopContainer #time ").text(seconds >= 0 ? `refresh time：${day}days, ${hours}:${minutes}:${seconds}` : '')
		}, 500)
	}
